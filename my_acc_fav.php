...
if($_SESSION["email"]){
	...
	mysqli_stmt_bind_result($call,$id_product,$title,$type,$genre,$producer,$product_price,$poster,$promotion,$promo_percent);
...
<script type="text/javascript">
    ...
    for (var i = 0; i <result; i++) {
    	if(array_promotion[i]==1){
    		array_new_price[i]=(array_product_price[i]-array_product_price[i]*(array_promo_percent[i]/100)).toFixed(2);
    	}
    	else{
