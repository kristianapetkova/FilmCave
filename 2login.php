...
<body>
	...
	<main>
		...
		<div style="width: 50%;">
			...
			<h2>
				Влезте в профила си или <a href="register.php"><i>се регистрирайте</i></a>
			</h2>
			<form method="POST" action="login_server.php">
				...
				<br>
				<input type="text" name="email" class="login_data" id="login_email" required value='<?php echo $_SESSION["email_conf"]; ?>'>
				<br>
				<br>
				<label for="password">
					Парола:
				...
				<br>
				<input type="password" name="password" class="login_data" id="login_password" required value='<?php echo $_SESSION["pass_conf"]; ?>'>
				<input type="text" class="error_msg" id="error_msg" value='<?php echo $_SESSION["error_msg"]; ?>' disabled>
				<br>
				...
				<br>
				<span class="forgotenpass">
					<a href=""><u>Забравена парола?</u></a>
				</span>
				<br>
				<button type="submit" class="buttons" name="login" >ВХОД</button>
...
<script type="text/javascript">
	...
	if(error_msg==""){
		error_msg.style.dispaly="none";
	}
	else{
		error_msg.style.dispaly="block";
	}
